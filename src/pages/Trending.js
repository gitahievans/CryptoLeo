...
const Trending = () => {
  ...
  return (
    <section className="w-[80%] h-full flex flex-col sm:w-full mt-16 mb-24 relative">
      <div className="w-full min-h-[60vh] py-8 flex flex-wrap justify-evenly  border border-gray-100 rounded">
        ...
        <button
          className="w-[2rem] sm:w-full ml-4 hover:scale-110 transition-all transition-ease
