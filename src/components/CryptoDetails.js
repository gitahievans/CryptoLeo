...
const CryptoDetails = () => {
    ...
    <div className='fixed top-0 w-full h-full bg-gray-200 bg-opacity-30 first-letter:backdrop-blur-sm flex items-center
    justify-center font-nunito' onClick={close}>
        ...
        ' onClick={(e) => e.stopPropagation()}>
            {
                ...
                <div className='flex items-center justify-between w-full h-full p-4'>
                    <div className='flex flex-col w-[45%] h-full pr-2'>
                        ...
                        <span className='text-sm py-0.5 px-2.5 ml-2 bg-cyan text-cyan bg-opacity-25
                        rounded uppercase'>{data.symbol}</span>
                        </div>
                        ...
                        <div className='flex w-full mt-6'>
                            <div className='flex flex-col w-full'>
                                ...
                                <div className={`text-sm px-1 ml-2 font-medium flex items-center rounded
                                uppercase bg-opacity-25 ${data.market_data.price_change_percentage_24h > 0
                                ...
                                ><span>{Number(data.market_data.price_change_percentage_24h).toFixed(2)}%</span>
                                    ...
                                    className={`w-[1rem] ml-0.5 ${data.market_data.price_change_percentage_24h > 0
                        ...
                        <div className='flex flex-col mt-4'>
                            <h3 className='text-white py-1'>
                                <span className='text-gray-100 capitalize mr-1'>
                                    market cap rank: </span>{data.market_cap_rank}</h3>

                            <h3 className='text-white py-1'>
                                <span className='text-gray-100 capitalize mr-1'>
                                    coingecko rank: </span>{data.coingecko_rank}</h3>

                            <h3 className='text-white py-1'>
                                <span className='text-gray-100 capitalize mr-1'>
                                    coingecko score: </span>{data.coingecko_score}</h3>
                        </div>
                    </div>

                    <div className='absolute bottom-8 right-8 flex item-center'>
                        {
                        ...
                        }
                        {
                            ...
                            <a className="text-lg px-1" target={"_blank"} rel='noreferrer' href={`https://github.com/${data.links.twitter_screen_name}`}>
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="1em"
                                    height="1em"
